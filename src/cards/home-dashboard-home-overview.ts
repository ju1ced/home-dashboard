  ...
  private async render(): Promise<void> {
    ...
    if (config.today?.enabled) {
      ...
      if (config.show_weather !== false && config.today.weather_entity) {
        ...
        weatherCard.className = "compact-weather";

  ...
  private async render(): Promise<void> {
    ...
    const buildSpecialistNavigation = (compact = false): HTMLElement | undefined => {
      const specialistNames: Record<keyof SpecialistsConfig, [string, string, string, string]> = {
        kia: ["Auto", "Voertuig", "mdi:car-electric", "specialist-kia"], printer: ["Printer", "3D-print", "mdi:printer-3d-nozzle", "specialist-printer"], robot: ["Robot", "Schoonmaak", "mdi:robot-vacuum", "more"], garden: ["Tuin", "Buiten", "mdi:flower", "more"], pool: ["Zwembad", "Waterkwaliteit", "mdi:pool", "more"]
      };

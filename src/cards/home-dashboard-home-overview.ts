...
export class HomeDashboardHomeOverview extends HTMLElementBase {
  ...
  private async render(): Promise<void> {
    ...
    style.textContent = `
      ...
      .top.joined{padding-top:8px;padding-bottom:16px;row-gap:12px}.top.joined .intro{align-self:start}
    ...
    top.className = config.navigation_mode && config.navigation_mode !== "native" ? "top joined" : "top";

...
interface NavigationConfig {
  ...
  active?: ViewPath | "room" | "specialist-kia" | "specialist-pool";
...
export class HomeDashboardNavigation extends HTMLElementBase {
  ...
  private render(): void {
    ...
    const active = this.config.active === "room" ? "rooms" : this.config.active === "specialist-kia" || this.config.active === "specialist-pool" ? "domains" : this.config.active;

...
export const EDITOR_COVERAGE = Object.freeze({
  ...
  collection_fields: [
    ...
    "rooms[].light_entities", "rooms[].cover_entities", "rooms[].media_entities", "rooms[].safety_entities", "rooms[].camera_entities", "rooms[].power_entities", "rooms[].history_entities", "rooms[].image_entity", "rooms[].temperature_history_entity", "rooms[].smart_plugs[]", "rooms[].desk",

...
Deze repository bouwt een HACS-installeerbare community dashboard strategy voor een centraal Home Assistant-dashboard. De HACS-foundation en grafische configuratie zijn in Home Assistant gevalideerd; `v0.5.0-alpha.2` herbouwt Home, de kamerkaarten en kamerdetails tot begrensde, responsive composities die veel dichter bij de goedgekeurde renders liggen. Home Assistant is niet door deze repository gewijzigd.

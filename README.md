...
Deze repository bouwt een HACS-installeerbare community dashboard strategy voor een centraal Home Assistant-dashboard. De HACS-foundation en grafische configuratie zijn in Home Assistant gevalideerd; `v0.5.0-alpha.7` brengt de driedelige Home-layout visueel in lijn met Juiced Horizon Calm en vervangt de hoge native weerkaart door een compacte forecastpresentatie. Home Assistant is niet door deze repository gewijzigd.

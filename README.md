...
Deze repository bouwt een HACS-installeerbare community dashboard strategy voor een centraal Home Assistant-dashboard. De HACS-foundation en grafische configuratie zijn in Home Assistant gevalideerd; `v0.5.0-alpha.4` herstelt de enkelvoudige entityselectors voor de vijf configureerbare energie-KPI's en de overige GUI-secties. Home Assistant is niet door deze repository gewijzigd.

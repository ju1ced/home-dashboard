...
Deze repository bouwt een HACS-installeerbare community dashboard strategy voor een centraal Home Assistant-dashboard. De HACS-foundation en grafische configuratie zijn in Home Assistant gevalideerd; `v0.5.0-alpha.3` voegt vijf expliciet configureerbare energie-KPI's toe aan de visuele Home- en Kamers-baseline. Home Assistant is niet door deze repository gewijzigd.

...
- **Deliverystatus:** `v0.5.0-alpha.2` levert een floor-gegroepeerd overzicht met gemapte apparaatchips en een samenhangend responsive kamerdashboard. Chips en apparaatkaarten openen alleen het standaard HA-detailvenster; directe quick actions blijven open tot hun actiegates bewezen zijn.

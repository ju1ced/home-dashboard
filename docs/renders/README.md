...
Visuele QA controleerde iedere PNG op horizontale overflow, elementgrenzen, afgesneden labels, stacking, contrastindruk en touch targets. Op Home zijn bovendien Vandaag, de twee person cards, de drie camerakaarten, horizontale camerascroll en afzonderlijke privacycontrols gecontroleerd. De kamerdetailrender bevat de rijke comfort-, klimaat-, historie- en apparaatinformatie; Energie heeft afzonderlijke desktop- en mobiele baselines. Browserconsole: geen fouten of waarschuwingen. De repositorycheck valideert bestandsafmetingen en aanwezigheid.
